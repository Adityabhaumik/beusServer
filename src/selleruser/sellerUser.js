...
sellerUserSchema.virtual('sellerProducts',{
    ref:'sellerProducts',
    localField:'-id',
    foreignField:'owner'
})
...
sellerUserSchema.methods.toJSON = function () { 
...
sellerUserSchema.methods.generateSellerAuthToken = async function (){
...
//Find BY CREDENTIAL FOR LOGIN 
    ...
    sellerUserSchema.statics.findByCredential = async (email, password) =>{
